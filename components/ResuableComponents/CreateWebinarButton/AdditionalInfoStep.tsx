...

          {
            couponEnabled && (
              <div className='space-y-2'> 
                  ...
                  className={cn('bg-background/50 border border-input', errors.couponCode && 'border-red-400 focus-visible:ring-red-400')}
                  />
                  {errors.couponCode &&(
                  ...
                  <div className='flex items-start gap-2 text-sm text-gray-400 mt-2'>
                      ...
                      <p>
                        This coupon code can be use to promote a sale. Users can use it for the buy now CTA
                      </p>
                  </div>
              </div>
            )
