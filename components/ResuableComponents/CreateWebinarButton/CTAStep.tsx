  ...
  return (
    <div className='space-y-6'>
        <div className='space-y-2'>
            ...
            className={cn(
            'bg-background/50! border border-input', errors.ctaLabel && 'border-red-400 focus-visible:ring-red-400'
            ) }/>
            {errors.ctaLabel &&
            (
        ...
        <div className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2 mt-2'>
                    {tags.map((tag: string, index: number )=>(
                        ...
                        >
                            ...
                            className='text-gray-400 hover:text-white'><X className='h-3 w-3'/></button>
                        </div>
            ...
            <div className='space-y-2 w-full'>
                ...
                <Tabs
                defaultValue={CtaTypeEnum.BOOK_A_CLASS}
                className='w-full'
                >
                    <TabsList className="w-full bg-transparent">
                        <TabsTrigger
                        value={CtaTypeEnum.BOOK_A_CLASS}
                        className="w-1/2 data-state-active:bg-background/50!"
                        onClick={()=>handleSelectCTAType(CtaTypeEnum.BOOK_A_CLASS)}
                        >
                            Book a Class
             ...
             <div className='space-y-2'>
                ...
                >
                    <SelectTrigger className="w-full bg-background/50 border border-input">
                        ...
                        <SelectContent className="bg-background border border-input max-w-48">
