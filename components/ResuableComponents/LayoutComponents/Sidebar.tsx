...
const Sidebar = () => {
  ...
  return (
    <div className="w-18 sm:w-28 h-screen sticky top-0 py-10 px-2 sm:px-6 border bg-background border-border flex flex-col
items-center justify-start gap-10">
      ...
      <div className='w-full h-full justify-between items-center flex flex-col'>
        <div className='w-full h-fit flex flex-col gap-4 item s-center justify-center'>
